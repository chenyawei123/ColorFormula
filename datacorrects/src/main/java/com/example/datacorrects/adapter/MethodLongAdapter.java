...
public class MethodLongAdapter extends RecyclerView.Adapter<MethodLongAdapter.AdapterRYViewHolder>  {
    //接收到的已完成菜品信息
    ...
    public MethodLongAdapter(Context mContext,List<MainLongBean> datas){
