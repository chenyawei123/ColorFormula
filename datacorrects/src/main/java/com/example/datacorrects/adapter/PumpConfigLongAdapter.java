...
public class PumpConfigLongAdapter extends RecyclerView.Adapter<PumpConfigLongAdapter.AdapterRYViewHolder>  {
    //接收到的已完成菜品信息
    ...
    public PumpConfigLongAdapter(Context mContext,List<MainLongBean> datas){
