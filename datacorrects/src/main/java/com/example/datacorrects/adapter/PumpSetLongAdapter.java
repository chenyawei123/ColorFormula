...
public class PumpSetLongAdapter extends RecyclerView.Adapter<PumpSetLongAdapter.AdapterRYViewHolder>  {
    //接收到的已完成菜品信息
    ...
    public PumpSetLongAdapter(Context mContext,List<MainLongBean> datas){
