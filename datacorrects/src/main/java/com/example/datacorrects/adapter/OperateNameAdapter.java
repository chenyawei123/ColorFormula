 ...
 * author： cyw
 */
public class OperateNameAdapter extends SimpleAdapter<String> {
    private List<String> datas = new ArrayList<>();
    private Context mContext;
    private TextView tvOperate;
    public OperateNameAdapter(Context context, int layoutResId) {
        super(context, layoutResId);
    }

    public OperateNameAdapter(Context context, List<String> datas) {
        super(context, R.layout.pop_operatename_item, datas);
