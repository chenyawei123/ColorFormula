...
static void **mSlot = nullptr;//run函数的地址【不是值】
...
//Java_com_cyw_mylibrary_application_StartupNativeLib_delayGC(JNIEnv *env, jobject){
//    delayGC();
//}
extern "C"
JNIEXPORT void JNICALL
Java_com_santint_colorformula_StartupNativeLib_delayGC(JNIEnv *env, jobject thiz) {
    // TODO: implement delayGC()
    delayGC();
}