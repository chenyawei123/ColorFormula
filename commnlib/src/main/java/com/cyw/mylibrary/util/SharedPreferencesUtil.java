...
public class SharedPreferencesUtil {
    ...
    private static final String FILE_NAME = "MilkFormula.json";
    private static final String milkFormulPath = SDCardUtils.getSDCardPathByEnvironment() + "/colorformula" + "/correctmilk/";
    ...
    public static void saveData(Context context, String key, Object data) {
        try {
            ...
            field.setAccessible(true);
            // 创建自定义路径
            File file = FileUtils.getFileByPath(milkFormulPath);
